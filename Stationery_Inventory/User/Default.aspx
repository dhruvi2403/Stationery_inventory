<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
    Inherits="Stationery_Inventory.User.Default" %>
                    ...
                    <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                        ...
                        <a href="" class="cat-img position-relative overflow-hidden mb-3">
                            <img class="img-fluid w-100" style="height: 300px; object-fit: cover;"
                                src="../UserTemplate/img/cat-1.jpg" alt="">
                        </a>
                        <h5 class="font-weight-semi-bold m-0">Pens & Pencils</h5>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 pb-1">
                    <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                        <p class="text-right">12 Products</p>
                        <a href="" class="cat-img position-relative overflow-hidden mb-3">
                            <img class="img-fluid w-100" style="height: 300px; object-fit: cover;"
                                src="../UserTemplate/img/cat-2.jpg" alt="">
                        </a>
                        <h5 class="font-weight-semi-bold m-0">Notebooks</h5>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 pb-1">
                    <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                        ...
                        <a href="" class="cat-img position-relative overflow-hidden mb-3">
                            <img class="img-fluid w-100" style="height: 300px; object-fit: cover;"
                                src="../UserTemplate/img/cat-3.jpg" alt="">
                        </a>
                        <h5 class="font-weight-semi-bold m-0">Art Supplies</h5>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 pb-1">
                    <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                        ...
                        <a href="" class="cat-img position-relative overflow-hidden mb-3">
                            <img class="img-fluid w-100" style="height: 300px; object-fit: cover;"
                                src="../UserTemplate/img/cat-4.jpg" alt="">
                        </a>
                        <h5 class="font-weight-semi-bold m-0">Desk Organizers</h5>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 pb-1">
                    <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                        ...
                        <a href="" class="cat-img position-relative overflow-hidden mb-3">
                            <img class="img-fluid w-100" style="height: 300px; object-fit: cover;"
                                src="../UserTemplate/img/cat-5.jpg" alt="">
                        </a>
                        <h5 class="font-weight-semi-bold m-0">Folders & Binders</h5>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 pb-1">
                    <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                        ...
                        <a href="" class="cat-img position-relative overflow-hidden mb-3">
                            <img class="img-fluid w-100" style="height: 300px; object-fit: cover;"
                                src="../UserTemplate/img/cat-6.jpg" alt="">
                        </a>
            ...
            <div class="row px-xl-5">
                <div class="col-md-6 pb-4">
                    <div class="position-relative bg-secondary text-center text-md-right text-white mb-2 py-5 px-5">
                        ...
                        <div class="position-relative" style="z-index: 1;">
                            ...
                            <h1 class="mb-4 font-weight-semi-bold">Back to School</h1>
                ...
                <div class="col-md-6 pb-4">
                    <div class="position-relative bg-secondary text-center text-md-left text-white mb-2 py-5 px-5">
                        ...
                        <div class="position-relative" style="z-index: 1;">
                            <h5 class="text-uppercase text-primary mb-3">20% off the order</h5>
                            <h1 class="mb-4 font-weight-semi-bold">Gift Collection</h1>
                            <a href="" class="btn btn-outline-primary py-md-2 px-md-3">Shop Now</a>
                        </div>
                    </div>
                </div>
