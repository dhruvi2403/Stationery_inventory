<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="Stationery_Inventory.Admin.Category" %>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <asp:TextBox ID="txtCategoryName" runat="server" CssClass="form-control" placeholder="Empty Category name"></asp:TextBox>
                        ...
                        <asp:Repeater ID="rCategory" runat="server" onItemCommand="rCategory_ItemCommand" >
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>  
                                        <img width="40" src="<%# Stationery_Inventory.Utils.getImageUrl(Eval("CategoryImageUrl")) %>" alt="image"/>
                                    </td>
                                    <td>
